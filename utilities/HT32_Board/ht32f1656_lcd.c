/*********************************************************************************************************//**
 * @file    ht32f1656_lcd.c
 * @version $Rev:: 923          $
 * @date    $Date:: 2015-09-16 #$
 * @brief   This file provides firmware functions to manage LEDs, push-buttons
 *          and COM ports and is available on HT32F1656 LCD Control Board.
 *************************************************************************************************************
 * @attention
 *
...
/** @defgroup HT32F1656_LCD HT32F1656_LCD
...
/* Private types -------------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_LCD_Private_TypesDefinitions HT32F1656 LCD private types definitions
  * @{
  */
...
/* Global variables ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_LCD_Global_Variable HT32F1656 LCD global variables
  * @{
  */
  ...
  const u8 LED_GPIO_ID[LEDn] = {LED1_GPIO_ID, LED2_GPIO_ID, LED3_GPIO_ID, LED4_GPIO_ID};
  const u16 LED_GPIO_PIN[LEDn] = {LED1_GPIO_PIN, LED2_GPIO_PIN, LED3_GPIO_PIN, LED4_GPIO_PIN};
  const AFIO_MODE_Enum LED_AFIO_MODE[LEDn] = {LED1_AFIO_MODE, LED2_AFIO_MODE, LED3_AFIO_MODE, LED4_AFIO_MODE};
...
/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_LCD_Global_Functions HT32F1656 LCD global functions
  * @{
  */
/*********************************************************************************************************//**
...
/* Private functions ---------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_LCD_Private_Functions HT32F1656 LCD private functions
  * @{
  */
/*********************************************************************************************************//**
